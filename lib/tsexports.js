...
function isTestCase(methodName) {
    var methodNameBlackList = [ 'constructor' ];   

    return methodName.indexOf('_') != 0 // any method whose name starts with '_' is not considered a test case
        && methodNameBlackList.indexOf(methodName) == -1; // any method on the blacklist is also ingore ;
};
